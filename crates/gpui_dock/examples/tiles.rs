...
use gpui::{
    App, Application, Bounds, Context, EventEmitter, FocusHandle, Focusable, IntoElement, Window,
    ...
    Application::new().with_assets(Assets).run(|cx: &mut App| {
        ...
        cx.open_window(WindowOptions::default(), |window, cx| {
            ...
            dock_area.update(cx, |area, cx| {
                // tiles() only uses DockItem::Panel and DockItem::Tabs; other variants are ignored.
