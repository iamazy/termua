    ...
    gpui_platform::application()
        ...
        .run(|cx: &mut App| {
            ...
            cx.open_window(WindowOptions::default(), |window, cx| {
                ...
                let center: Arc<dyn PanelView> =
                    Arc::new(cx.new(|cx| DemoPanel::new("Center", cx)));
                let left: Arc<dyn PanelView> = Arc::new(cx.new(|cx| DemoPanel::new("Left", cx)));
                let right_a: Arc<dyn PanelView> =
                    Arc::new(cx.new(|cx| DemoPanel::new("Right A", cx)));
                let right_b: Arc<dyn PanelView> =
                    Arc::new(cx.new(|cx| DemoPanel::new("Right B", cx)));
                let bottom: Arc<dyn PanelView> =
                    Arc::new(cx.new(|cx| DemoPanel::new("Bottom", cx)));
