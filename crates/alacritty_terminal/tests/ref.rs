...
use alacritty_terminal::{
    ...
    index::{Column, Line},
    term::{Config, Term, cell::Cell, test::TermSize},
    vte::ansi,
};
    ...
    P: AsRef<Path>,
{
    ...
    // Recordings are raw PTY streams. Depending on local git EOL normalization, these files can
    // end up with bare `\n` bytes (instead of the typical `\r\n` pair). The reference grids were
    // generated from streams with `\r\n`, so normalize here to make the ref tests robust.
